...
import com.demeter.cloud.core.constant.Formats;
...
public class DateTimeUtil {
	...
	public static String getDateTimeDisplay(LocalDateTime dateTime) {
		DateTimeFormatter dtf2 = DateTimeFormatter.ofPattern(Formats.DATE_FORMAT_TO_PM);
		String strDate2 = dtf2.format(dateTime);
	...
	public static String getDateTime(LocalDateTime dateTime) {
		DateTimeFormatter dtf2 = DateTimeFormatter.ofPattern("ss");
		String strDate2 = dtf2.format(dateTime);
		return strDate2;
	}

	public static String getDate(LocalDateTime dateTime) {
		DateTimeFormatter dtf2 = DateTimeFormatter.ofPattern(Formats.DATE_FORMAT_TO_DAY);
		String strDate2 = dtf2.format(dateTime);
		return strDate2;
	}
